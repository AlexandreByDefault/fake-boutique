...
const DetailsProduct = (props) => {
  ...
  return (
    ...
    <Image src={props.params.image} alt={props.params.title} width={400} height={400} />
    ...
    <table>
          ...
          <tr>
              ...
              <td>
              <span className={style.category}>{props.params.category}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span className={style.infosValue}>$ {props.params.price} </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                {" "}
                <Rating initialValue={props.params.rating} readonly size={32} /* Available Props */ />
              </td>
            </tr>
          </tbody>
        </table>
    </div>
    <Button onClick={handleClickButton} className={style.btn}>panier</Button>
    </div>
    </div>
    <di>
    <h3 className={style.subtitle}> Product in the same category</h3>
  { props.similar ? <Products items={props.similar} /> : 'No Similar product' }
    </di>
    </div>
...
export async function getStaticProps(context) {
  try {
    ...
    const sameCategory = products.filter((product) => product.category === productId.category )
